...
/**
 * Clase generadora de movimientos por usuario
 * @author albertoaraguas
 * @version 1.0
 */
public class InformeMovimientoUsuario {
     /**
  *  declaraciones publicas 
  */ 
  public static final String DEST = "C:\\librocaja\\Recibo\\InformeUsuario.pdf";
   /**
  *  declaraciones publicas 
  */ 
 ...
 * @param Usuarios string con todos los conceptos que existen
 ...
 */
  public InformeMovimientoUsuario(ConectorDB basedatos,String Usuarios,String Libro,String RangoFechas) throws FileNotFoundException, MalformedURLException, IOException {
 ...
 */ 
  final void GenerarInforme() throws FileNotFoundException, MalformedURLException, IOException{
      //lanzamos un popup avisando que espere mientras se genera el pdf, 
      VentanaEsperar ventana= new VentanaEsperar();
        ...
        //encabezado  
        doc.add(new Paragraph("------------------  INFORME DE MOVIMIENTOS POR USUARIO  -------------------------    AYUNTAMIENTO DE MONZON.SAC").addStyle(styleTitulo));
        ...
        List<String> listausuarios=basedatos.UsuariosIntervalo(ListaUsuarios, Libro, RangoFechas);
            for (String usuario : listausuarios){
                doc.add( new Paragraph(" "+usuario).addStyle(style));
                doc.add(new Paragraph(""));
            //por cada usuario sacamos los movimientos y los imprimimos
            resultados=basedatos.RegistrosUsuariosIntervalo(usuario, Libro, RangoFechas);
            double totalIn=0;
            double totalOut=0;
            ...
            tableR.addHeaderCell(new Paragraph("Concepto"));
            tableR.addHeaderCell(new Paragraph("Entradas"));
            tableR.addHeaderCell(new Paragraph("Salidas"));
